...
struct ChallengePayload: Codable {
    ...
    private static let maxEncodedLength = 4_096
    private static let maxNameLength    = 80
    private static let maxStatValue     = 1_000_000
    ...
    static func decode(from urlSafeBase64: String) -> ChallengePayload? {
        ...
        guard let data = Data(base64Encoded: base64),
              ...
              payload.fromName.count <= maxNameLength,
              (0...maxStatValue).contains(payload.streak),
              (0...maxStatValue).contains(payload.totalPoints)
        else { return nil }
        return payload
    }
}
