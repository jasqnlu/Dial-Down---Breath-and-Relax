"""Abdominal Lock Breath (Uddiyana Bandha Prep) — muscle-body + skin-head animation.
...
EXERCISE = "abdominal_lock_breath_uddiyana_bandha_prep"
VIDEO_NAME = "abdominal_lock_breath_uddiyana_bandha_prep.mp4"
