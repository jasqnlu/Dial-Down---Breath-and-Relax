"""Resonant Frequency Breathing (6 Breaths per Minute) — muscle-body + skin-head animation.
...
EXERCISE = "resonant_frequency_breathing_6_breaths_per_minute"
VIDEO_NAME = "resonant_frequency_breathing_6_breaths_per_minute.mp4"
