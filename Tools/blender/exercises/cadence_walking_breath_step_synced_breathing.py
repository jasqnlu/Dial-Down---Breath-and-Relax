"""Cadence Walking Breath (Step-Synced Breathing) — muscle-body + skin-head animation.
...
EXERCISE = "cadence_walking_breath_step_synced_breathing"
VIDEO_NAME = "cadence_walking_breath_step_synced_breathing.mp4"
