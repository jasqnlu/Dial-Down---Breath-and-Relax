"""Physiological Sigh (Double Inhale Exhale) — muscle-body + skin-head animation.
...
EXERCISE = "physiological_sigh_double_inhale_exhale"
VIDEO_NAME = "physiological_sigh_double_inhale_exhale.mp4"
