"""Right Kneeling Quad Stretch — muscle-body + skin-head animation.
...
Highlight: Right Quadriceps, Right Hip Flexors.
"""
import sys
import os
...
EXERCISE = "right_kneeling_quad_stretch"
VIDEO_NAME = "right_kneeling_quad_stretch.mp4"

WORKED_KEYWORDS = ("right quadricep", "right hip")
