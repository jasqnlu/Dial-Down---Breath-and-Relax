"""Kneeling Couch Stretch, Rear Foot Elevated (Left) — muscle-body + skin-head animation.
...
EXERCISE = "kneeling_couch_stretch_rear_foot_elevated_left"
VIDEO_NAME = "kneeling_couch_stretch_rear_foot_elevated_left.mp4"
