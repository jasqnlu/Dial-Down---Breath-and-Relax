"""Right-Nostril Energizing Breath (Surya Bhedana) — muscle-body + skin-head animation.
...
EXERCISE = "right_nostril_energizing_breath_surya_bhedana"
VIDEO_NAME = "right_nostril_energizing_breath_surya_bhedana.mp4"
