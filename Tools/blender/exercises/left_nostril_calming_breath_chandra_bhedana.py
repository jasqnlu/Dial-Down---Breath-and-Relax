"""Left-Nostril Calming Breath (Chandra Bhedana) — muscle-body + skin-head animation.
...
EXERCISE = "left_nostril_calming_breath_chandra_bhedana"
VIDEO_NAME = "left_nostril_calming_breath_chandra_bhedana.mp4"
