"""Extended Kumbhaka Breath Retention — muscle-body + skin-head animation.
...
EXERCISE = "extended_kumbhaka_breath_retention"
VIDEO_NAME = "extended_kumbhaka_breath_retention.mp4"
