"""Wall-Assisted Toe Extension Stretch (Left) — muscle-body + skin-head animation.
...
EXERCISE = "wall_assisted_toe_extension_stretch_left"
VIDEO_NAME = "wall_assisted_toe_extension_stretch_left.mp4"
