"""Right Wrist Flexor Stretch — mirror of the left version.

See left_wrist_flexor_stretch.py's docstring. Flagged
...
EXERCISE = "right_wrist_flexor_stretch"
VIDEO_NAME = "right_wrist_flexor_stretch.mp4"
