"""Diaphragmatic Breath with Counting — muscle-body + skin-head animation.
...
EXERCISE = "diaphragmatic_breath_with_counting"
VIDEO_NAME = "diaphragmatic_breath_with_counting.mp4"
