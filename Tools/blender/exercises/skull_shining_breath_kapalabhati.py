"""Skull Shining Breath (Kapalabhati) — muscle-body + skin-head animation.
...
EXERCISE = "skull_shining_breath_kapalabhati"
VIDEO_NAME = "skull_shining_breath_kapalabhati.mp4"
