"""Breath of Gratitude (Affective Labeling Breath) — muscle-body + skin-head animation.
...
EXERCISE = "breath_of_gratitude_affective_labeling_breath"
VIDEO_NAME = "breath_of_gratitude_affective_labeling_breath.mp4"
