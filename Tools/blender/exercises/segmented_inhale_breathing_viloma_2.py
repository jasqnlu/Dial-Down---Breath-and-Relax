"""Segmented Inhale Breathing (Viloma 2) — muscle-body + skin-head animation.
...
EXERCISE = "segmented_inhale_breathing_viloma_2"
VIDEO_NAME = "segmented_inhale_breathing_viloma_2.mp4"
