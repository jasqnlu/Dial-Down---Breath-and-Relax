"""Wave Breath (Sequential Full-Body Breath) — muscle-body + skin-head animation.
...
EXERCISE = "wave_breath_sequential_full_body_breath"
VIDEO_NAME = "wave_breath_sequential_full_body_breath.mp4"
