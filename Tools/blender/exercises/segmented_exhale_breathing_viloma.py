"""Segmented Exhale Breathing (Viloma) — muscle-body + skin-head animation.
...
EXERCISE = "segmented_exhale_breathing_viloma"
VIDEO_NAME = "segmented_exhale_breathing_viloma.mp4"
