"""Cyclic Sighing (Multi-Cycle Protocol) — muscle-body + skin-head animation.
...
EXERCISE = "cyclic_sighing_multi_cycle_protocol"
VIDEO_NAME = "cyclic_sighing_multi_cycle_protocol.mp4"
