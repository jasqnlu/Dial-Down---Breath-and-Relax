"""Sitkari Breath (Hissing Cooling Breath) — muscle-body + skin-head animation.
...
EXERCISE = "sitkari_breath_hissing_cooling_breath"
VIDEO_NAME = "sitkari_breath_hissing_cooling_breath.mp4"
