"""Reclined Figure-Four Stretch with Strap (Left) — muscle-body + skin-head animation.

40-exercise thin-coverage batch (session 2026-08-26). Same solved figure-4 cross as left_supine_figure_4.py.
...
EXERCISE = "reclined_figure_four_stretch_with_strap_left"
VIDEO_NAME = "reclined_figure_four_stretch_with_strap_left.mp4"
