"""Descending Ladder Breath (Step-Down Countdown) — muscle-body + skin-head animation.
...
EXERCISE = "descending_ladder_breath_step_down_countdown"
VIDEO_NAME = "descending_ladder_breath_step_down_countdown.mp4"
