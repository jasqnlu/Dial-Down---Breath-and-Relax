"""Natural Breath Awareness (Anapana Meditation) — muscle-body + skin-head animation.
...
EXERCISE = "natural_breath_awareness_anapana_meditation"
VIDEO_NAME = "natural_breath_awareness_anapana_meditation.mp4"
