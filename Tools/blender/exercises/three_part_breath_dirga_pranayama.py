"""Three-Part Breath (Dirga Pranayama) — muscle-body + skin-head animation.
...
EXERCISE = "three_part_breath_dirga_pranayama"
VIDEO_NAME = "three_part_breath_dirga_pranayama.mp4"
