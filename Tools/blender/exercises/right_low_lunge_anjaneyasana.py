"""Right Low Lunge (Anjaneyasana) — muscle-body + skin-head animation.
...
Highlight: Right Hip Flexors, Left Abs, Right Abs.
"""
import sys
import os
...
EXERCISE = "right_low_lunge_anjaneyasana"
VIDEO_NAME = "right_low_lunge_anjaneyasana.mp4"

WORKED_KEYWORDS = ("right hip", "abs")
